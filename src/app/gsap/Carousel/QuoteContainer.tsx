...
export const QuoteContainer = ({ slide }: tProps) => {
  return (
    <div className="text-accent-gold text-center lg:text-left">
      <svg
        width="53"
        height="41"
        viewBox="0 0 53 41"
        fill="none"
        aria-hidden="true"
        className="w-10 h-8 lg:w-[53px] lg:h-[41px] mx-auto lg:mx-0"
      >
        <path
      ...
      <div className="flex flex-col gap-6 mt-6 lg:gap-8 lg:mt-8">
        <p
          data-quote
          className="text-surface-light font-heading text-[28px] leading-[1.2em] tracking-[-0.28px] lg:text-[clamp(1.75rem,2vw+1rem,2.5rem)] lg:leading-[1.3em] lg:tracking-[-1%] font-normal"
        >
          {slide.quote}
        </p>
